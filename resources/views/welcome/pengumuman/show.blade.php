    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-12 col-12">
                ...
                <h2 class="breadcrumb-title">Pengumuman Detail</h2>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="blog-view">
                    <div class="blog blog-single-post">
                        <h3 class="blog-title">{{$pengumuman->title}}</h3>
                        <div class="blog-image">
                            <a href="javascript:void(0);"><img alt="" src="/storage/{{ str_replace('.jpg','.jpg', $pengumuman->image) }}" class="img-fluid"></a>
                        </div>
                        <div class="blog-info clearfix">
                            <div class="post-left">
                                <ul>
                                    <li>
                                        <i class="far fa-user"></i> {{$pengumuman->Author->name }}
                                    </li>
                                    <li><i class="far fa-calendar"></i>{{$pengumuman->created_at->format('d-m-Y')}}</li>
                                    <li><i class="far fa-eye"></i> {{ $pengumuman->view }}</li>
                                    {{-- <li><i class="fas fa-eye"></i> Dibaca: {{ TutaComp::countReadPengumuman($pengumuman->uuid) }} Kali</li> --}}
