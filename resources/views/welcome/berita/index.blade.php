                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="blog grid-blog">
                            <div class="blog-image">
                                <a href="{{ route('berita.show', $value->slug) }}"><img class="img-fluid" src="/storage/{{ str_replace('.jpg','-medium.jpg', $value->image) }}" style="width:593px; height:369px;" alt="Post Image"></a>
                            </div>
            ...
            <div class="col-lg-4 col-md-12 sidebar-right theiaStickySidebar">
                ...
                <div class="card post-widget">
                    <div class="card-header">
                        <h4 class="card-title">Berita Terpopuler</h4>
                    </div>
                    <div class="card-body">
                        <ul class="latest-posts">
                            ...
                            <li>
                                ...
                                <div class="post-info">
                                    <h4>
                                        <a href="{{ route('berita.show', $latest->slug) }}">{{ $latest->title }}</a>
                                    </h4>
