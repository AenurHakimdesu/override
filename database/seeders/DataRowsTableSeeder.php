...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $agendaDataType = DataType::where('slug', 'agendas')->firstOrFail();
        $runningTextDataType = DataType::where('slug', 'running_texts')->firstOrFail();
        $tautanDataType = DataType::where('slug', 'tautans')->firstOrFail();
        ...
        $dataRow = $this->dataRow($albumDataType, 'parent_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'select_dropdown',
                'display_name' => 'Parent',
        ...
        $dataRow = $this->dataRow($albumDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Nama Album',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($albumDataType, 'lokasi');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Lokasi',
        ...
        $dataRow = $this->dataRow($photoDataType, 'foto');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => 'Foto',
        ...
        $dataRow = $this->dataRow($photoDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Created At',
        ...
        $dataRow = $this->dataRow($photoDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Updated At',
        ...
        $dataRow = $this->dataRow($photoDataType, 'photo_belongsto_album_relationship');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'relationship',
                'display_name' => 'Album',
                ...
                'add'          => 1,
                'delete'       => 1,
                'details'      => '{"model":"App\\Album","table":"albums","type":"belongsTo","column":"album_id","key":"id","label":"name","pivot_table":"albums","pivot":"0","taggable":"0"}',
                'order'        => 6,
            ])->save();
        }
        ...
        $dataRow = $this->dataRow($videoDataType, 'url');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Url',
        ...
        $dataRow = $this->dataRow($videoDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Judul',
        ...
        $dataRow = $this->dataRow($agendaDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'ID',
        ...
        $dataRow = $this->dataRow($agendaDataType, 'date_start');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'date',
        ...
        $dataRow = $this->dataRow($agendaDataType, 'date_end');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'date',
        ...
        $dataRow = $this->dataRow($agendaDataType, 'time_start');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'time',
                'display_name' => 'Waktu Mulai',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($agendaDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($agendaDataType, 'lokasi');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Lokasi',
        ...
        $dataRow = $this->dataRow($agendaDataType, 'desc');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($agendaDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Created At',
        ...
        $dataRow = $this->dataRow($agendaDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Updated At',
        ...
        $dataRow = $this->dataRow($agendaDataType, 'time_end');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'time',
                'display_name' => 'Waktu Selesai',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($runningTextDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'ID',
        ...
        $dataRow = $this->dataRow($runningTextDataType, 'text');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($runningTextDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Created At',
        ...
        $dataRow = $this->dataRow($runningTextDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Updated At',
        ...
        $dataRow = $this->dataRow($tautanDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'ID',
        ...
        $dataRow = $this->dataRow($tautanDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Judul',
        ...
        $dataRow = $this->dataRow($tautanDataType, 'url');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Url',
        ...
        $dataRow = $this->dataRow($tautanDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Created At',
        ...
        $dataRow = $this->dataRow($tautanDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Updated At',
